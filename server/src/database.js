...
const initUsers = (collection) => {
  collection.insertMany([
    ...
    {"mail":"boss@wp.pl", "password": "123", "name": "Marek", "surname": "Boss", "address": "ul. Nowa 41 Wrocław", "phone": "785467111", "role": "boss", "grade": "5", "projectId": null, "imageURL" : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1KYdVbr_q9oPjjbBDx9se1reB9_DhUcpwwzGtkeLCSyp8v9dr"}
  ])
}
